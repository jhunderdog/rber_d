...
class AssistantMethods {
  ...
  static Future<DirectionDetails> obtainDirectionDetails(
    ...
    String directionUrl =
        "https://maps.googleapis.com/maps/api/directions/json?origin=${initialPosition.latitude},${initialPosition.longitude}&destination=${finalPosition.latitude},${finalPosition.longitude}&mode=transit&key=$mapKey";
